...
export async function getServerSideProps() {
  ...
  const discoverBanner = await res.data?.snippets?.find(
...
const Discover = ({ discoverBanner }) => {
  console.log(discoverBanner);
              ...
              <div className="container-fluid">
                <div className="--content">
                  ...
                  <div className="--bot d-flex justify-content-between align-items-end">
                    ...
                    <div className="--txt">
                      <article>
                        Là vùng lãnh thổ với nhiều dãy núi và cao nguyên, phía
                        Đông khu vực này là dãy núi Hoàng Liên Sơn, phía Tây là
                        dãy núi Sông Mã có độ cao 1.800m. Giữa hai dãy núi đồ sộ
                        trên là phần đất thuộc vùng núi thấp tương đối rộng lớn
                        và lưu vực sông Đà
                      </article>
                    </div>
                  </div>
